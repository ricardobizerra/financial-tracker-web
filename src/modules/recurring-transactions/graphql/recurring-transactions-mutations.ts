...
export const IgnorePossibleRecurrenceMutation = graphql(`
  mutation IgnorePossibleRecurrence($description: String!) {
    ignorePossibleRecurrence(description: $description)
  }
`);
