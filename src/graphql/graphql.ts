...
export type BulkCancelTransactionsInput = {
...
export type Mutation = {
  ...
  bulkCancelTransactions: Array<TransactionModel>;
  bulkUpdateTransactions: Array<TransactionModel>;
  cancelRecurringTransactions: TransactionModel;
...
export type MutationBulkCancelTransactionsArgs = {
  data: BulkCancelTransactionsInput;
};
...
export type MutationCancelRecurringTransactionsArgs = {
...
export type CancelRecurringTransactionsMutationVariables = Exact<{
  transactionId: Scalars['String']['input'];
  scope: UpdateRecurringScope;
}>;


export type CancelRecurringTransactionsMutation = { __typename?: 'Mutation', cancelRecurringTransactions: { __typename?: 'TransactionModel', id: string, status: TransactionStatus } };
...
export type BulkUpdateTransactionsMutation = { __typename?: 'Mutation', bulkUpdateTransactions: Array<{ __typename?: 'TransactionModel', id: string, category: TransactionCategory | null }> };

export type BulkCancelTransactionsMutationVariables = Exact<{
  data: BulkCancelTransactionsInput;
}>;


export type BulkCancelTransactionsMutation = { __typename?: 'Mutation', bulkCancelTransactions: Array<{ __typename?: 'TransactionModel', id: string, status: TransactionStatus }> };
...
export const BulkCancelTransactionsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"BulkCancelTransactions"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BulkCancelTransactionsInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bulkCancelTransactions"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]} as unknown as DocumentNode<BulkCancelTransactionsMutation, BulkCancelTransactionsMutationVariables>;
